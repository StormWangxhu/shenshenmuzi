import{_ as d}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as p,c as m,f as v,a as e,w as a,b as n,e as t,d as s,r as i}from"./app.ae466858.js";const b={},h=t(`<p>By injecting configuration into vuepress-plugin-container, you can use</p><div class="language-markdown ext-md line-numbers-mode"><pre class="language-markdown"><code>::: center
Paragraph to center
:::
...
:::
::::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function j(N,S){const l=i("CodeTabs"),o=i("ExternalLinkIcon");return p(),m("div",null,[h,v(" more "),g,e(l,{hash:"978655d0",data:[{title:"TS"},{title:"JS"}],"tab-id":"language"},{tab0:a(({title:c,value:r,isActive:u})=>[k]),tab1:a(({title:c,value:r,isActive:u})=>[_]),_:1}),f,n("div",y,[x,w,P,E,n("div",V,[n("p",null,[n("a",I,[T,e(o)]),A])])]),C])}const H=d(b,[["render",j],["__file","align.html.vue"]]);export{H as default};
